...
namespace EFCore.ReturningExtensions.Tests
{
    ...
    {
        [TestMethod]
        public void Updated_WhenSqlServerAndMixed_ReturnUpdateWithOutputClause()
        {
            // Arrange
        ...
        [TestMethod]
        public void Updated_WhenSqlServerAndDeletedOnly_ReturnUpdateWithOutputClause()
        {
            // Arrange
            using var scope = new ServiceCollection()
                .AddDbContext<SqlUsersDbContext>()
        ...
        [TestMethod]
        public void Updated_WhenSqlServerFallback_ReturnUpdateWithOutputClause()
        {
            // Arrange
            using var scope = new ServiceCollection()
                .AddDbContext<SqlUsersDbContext>()
